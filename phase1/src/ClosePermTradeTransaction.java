...
public class ClosePermTradeTransaction {

    public void confirmTransaction(String username, Trade a) {
        a.confirmTransaction(username); //confirmTransaction should apply to a Temp Trade since it applies to Trade (Liskov)
